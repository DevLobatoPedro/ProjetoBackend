...
export const clienteIndex = async (req, res) => {
  ...
  export const clienteRegistration = async (req, res) => {
...
if(senha.lenght < 8){
    ...
    res.status(400).json({id:0, msg: "erro...senha deve possuir, no minimo, 8 caracteres"})
    return;
}
...
if (pequenas == 0 || grandes == 0 || numeros == 0 || simbolos == 0) {
    res.status(400).json({ id: 0, msg: "Erro... senha deve letras minúsculas, maiúsculas, números e símbolos" })
    return
  }
